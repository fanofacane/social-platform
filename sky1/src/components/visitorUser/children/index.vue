...
import{querCardByIdApi,} from '@/api/user';
...
const searchCard = async () => {
  const res = await querCardByIdApi(user.value.id);
  if(res.code){
    list.value = res.data;
  }
}
        ...
        <div class="author-container">
          <div class="author-me">
            ...
            <!-- <div class="follow-btn" v-else>
              <el-button type="danger" size="large" round  @click="toggleFollow" >
              {{ '关注' }}
            </el-button> -->
            <!-- </div> -->
          </div>
          ...
          <div class="note-scroller"> 
            ...
            <div class="comments-el">
              <div class="comments-container" v-for="comment in selectedItem.commentsList" :key="comment.id">
                <div class="list-container">
                  <div class="parent-comment">
                    <div class="comment-item">
                      <div class="comment-inner-container">
                        <div class="avatar">
                          <img  class="avatar-item"  :src="comment.authorDetail.picture"  />
                        </div>
                        <div class="right">
                          <div class="author-wrapper">
                            <div class="author"><a class="name">{{ comment.authorDetail.username }}</a></div>
                          </div>
                          <div class="content">{{comment.content}}</div>

                          <div class="info">
                            <div class="date"><span>{{ comment.createTime }}</span></div>
                    ...
                    <div class="reply-container" v-for="reply in comment.repliesComment" :key="reply.id">
                      <div class="list-container">
                        <div class="comment-item" >
                          
                          <div class="comment-inner-container">
                            <div class="avatar">
                              <img  class="avatar-item"  :src="reply.authorDetail.picture"  />
                            </div>
                            <div class="right">
                              <div class="author-wrapper">
                                <div class="author"><a class="name">{{reply.authorDetail.username}}</a></div>
                              </div>
                              <div class="content">{{reply.content}}</div>

                              <div class="info">
                                <div class="date"><span>{{ reply.createTime }}</span></div>
                                <div class="interactions">
                                  <div class="like">
                                    <span class="like-wrapper">
                                      <Star style="width: 1em; height: 1em" />
        ...
        <div class="interactions-footer">
            ...
            <div class="comment-wrapper active comment-comp">
              <div class="input-wrapper">
                <input class="comment-input" type="text" placeholder="想说点什么呢！！" />
