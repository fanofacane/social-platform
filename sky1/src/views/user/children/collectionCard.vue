...
import {queryAllCardApi,queryAllCardDetailApi,toggleLikeApi,toggleCollectionApi} from '@/api/index';
...
const toggleLike =async (post) => {
  ...
  const requst=await querCollectionCardByIdApi();
  list.value = requst.data;
}
